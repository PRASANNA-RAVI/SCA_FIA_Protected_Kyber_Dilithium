...
#define poly_add_fia DILITHIUM_NAMESPACE(poly_add_fia)
...
#define poly_uniform_gamma1_fia DILITHIUM_NAMESPACE(poly_uniform_gamma1_fia)
...
#define polyz_unpack_fia DILITHIUM_NAMESPACE(polyz_unpack_fia)
