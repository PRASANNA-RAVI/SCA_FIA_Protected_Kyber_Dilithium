...
#define poly_tobytes_fia KYBER_NAMESPACE(poly_tobytes_fia)
void poly_tobytes_fia(uint8_t r[KYBER_POLYBYTES], const poly *a, int cmp_value_1, int cmp_value_2, int output_from_check_s_and_e);
...
void poly_ntt(poly *r, int protection);
#define poly_invntt_tomont KYBER_NAMESPACE(poly_invntt_tomont)
void poly_invntt_tomont(poly *r, int protection);
